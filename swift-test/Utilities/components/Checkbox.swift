...
public class Checkbox: UIControl {
    ...
    public var checkboxFillColorState: UIColor = .clear
    ...
    public var isChecked: Bool = false {
        didSet {
            if isChecked{
                checkboxFillColor = checkboxFillColorState
            }else{
                checkboxFillColor = .clear
            }
            setNeedsDisplay()
        }
    }
    ...
    convenience init(checkboxFillColorState: UIColor = .primaryTextColor, borderStyle: BorderStyle = .square, checkmarkStyle: CheckmarkStyle = .tick, cornerRadius: CGFloat = 3, checkmarkColor: UIColor = .white, checkedBorderColor: UIColor = .clear, uncheckedBorderColor: UIColor = .aSecondaryLabel, isChecked: Bool = false, size: CGFloat = 20) {
        self.init(frame: .zero)
        self.checkboxFillColorState = checkboxFillColorState
