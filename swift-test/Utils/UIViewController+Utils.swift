...
//    func configureNavBar(title: String, barBgColor: UIColor = .primaryYellow, font: UIFont = .avenirBold(size: 16), barTextColor: UIColor = .primaryTextColor, prefersLargeTitle: Bool = false) {
//        self.title = title
...
//    func configureNavBar(centerImage: UIImage? = R.image.autocheck_logo_all_clear(), barTintColor: UIColor = .primaryYellow, tintColor: UIColor = UIColor("#31355B"), height: CGFloat? = nil, width: CGFloat? = nil) {
